...
Monthly Total Return and Price Return series for the five analyzed asset classes (S&P 500, 7-10 Year Treasury Bonds, S&P GSCI Commodities, Gold, and US REITs) were originally extracted from **FactSet**. 
* Researchers can reconstruct these series using standard OHLCV data from alternative financial data providers (e.g., Bloomberg, Refinitiv, or Yahoo Finance).
